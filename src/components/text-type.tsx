...
const TextType = ({
  ...
  const initialText = startDeleting ? (Array.isArray(text) ? (text[0] ?? "") : text) : "";
  ...
  return (
    <Component ref={containerRef} className={`inline-block tracking-tight whitespace-pre-wrap ${className}`} {...props}>
