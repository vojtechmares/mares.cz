...
keywords:
  [
    "GitLab CI školení",
    "GitLab CI/CD kurz",
    "školení kontinuální integrace",
    "GitLab pipeline workshop",
    "GitLab automatizace buildů",
    "DevOps školení GitLab",
    "GitLab CI YAML konfigurace",
    "GitLab CI best practices",
    "CI/CD školení Praha",
    "školení pro vývojáře a DevOps",
    "GitLab cache a artefakty",
    "Docker v GitLab CI",
  ]
featured: false
length: 1
ad: |
  Chcete zrychlit vývoj a eliminovat chyby při nasazování?
  S GitLab CI se společně na školení naučíme, jak navrhnout a provozovat efektivní pipeline, nastavit Runnery, využívat cache a artefakty a plně automatizovat build–test–deploy.
  Přijďte na veřejný termín školení nebo si objednejte vše na míru pro váš tým.
price:
  open:
    - amount: 5400
      currency: CZK
  ...
  corporate:
    ...
    - amount: 1000
      currency: EUR
logo:
  src: /assets/training/gitlab.png
  alt: "GitLab logo"
icon:
  src: /assets/training/gitlab.svg
  alt: "GitLab icon"
draft: false
---
