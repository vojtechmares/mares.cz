...
length: 1
ad: |
  Zajímá Vás Git a chcete jej využít naplno nebo se s ním teprve seznamujete? Neváhejte přijít na moje školení, kde se dozvíte a vyzkoušíte, vše co potřebujete vědět o Gitu. Přihlaste se buď na veřejný termín nebo mě kontaktujte ohledně firemního školení.
price:
  open:
    - amount: 5400
      currency: CZK
