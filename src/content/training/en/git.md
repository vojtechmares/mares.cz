...
length: 1
ad: |
  Interested in Git and want to use it to its full potential, or are you just getting started? Come to my training where you will learn and practice everything you need to know about Git. Sign up for an open session or contact me about corporate training.
price:
  open:
    - amount: 5400
      currency: CZK
  ...
  corporate:
    ...
    - amount: 1000
      currency: EUR
logo:
  src: /assets/training/git.png
  alt: "Git logo"
icon:
  src: /assets/training/git.svg
  alt: "Git icon"
draft: false
---
