...
keywords:
  [
    ...
    "DevOps GitLab training",
    "GitLab CI YAML configuration",
    "GitLab CI best practices",
    "CI/CD training",
    "training for developers and DevOps",
    "GitLab cache and artifacts",
    "Docker in GitLab CI",
  ]
featured: false
length: 1
ad: |
  Want to speed up development and eliminate deployment errors?
  In this GitLab CI training, we will learn together how to design and run efficient pipelines, configure Runners, use cache and artifacts, and fully automate build-test-deploy.
  Sign up for an open session or order a custom training for your team.
price:
  open:
    - amount: 5400
      currency: CZK
