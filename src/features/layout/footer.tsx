...
function BlueskyIcon() {
  return (
    <svg
      ...
      className="h-6 w-6 fill-black group-hover:fill-neutral-700"
    >
    ...
    <Section className="border-t border-neutral-300">
      <footer>
        <Container>
          ...
          <div className="flex flex-col items-center border-t border-neutral-400/10 py-10 md:flex-row-reverse md:justify-between">
