...
import hashicorpTerraform from "@/images/logos/tools/hashicorp-terraform.png";
import hashicorp from "@/images/logos/hashicorp-horizontal.png";
...
export const meta = {
  ...
  keywords:
    "infrastruktura, terraform, infrastructure-as-code, devops, cloud, hashicorp",
  lang: "cs",
...
<Image src={hashicorpTerraform} alt="HashiCorp Terraform logo" />
...
<Image src={hashicorp} alt="HashiCorp logo" />
...
Pokud Vás zajímá Terraform více do hloubky a chtěli byste se s ním naučit víc nebo chcete aby Váš tým začal Terraform používat,
přijďte na moje [školení Terraformu](/skoleni/terraform).

Školení probíhá formou workshopu, kde si práci s Terraformem všichni sami vyzkouší.
Buď přijďte na veřejný termín nebo se domluvme na firemním školení, napište mi na email vojtech@mares.cz.
