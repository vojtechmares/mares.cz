...
import docker from "@/images/logos/docker-logo-blue.png";
import dockerWasBorn from "@/images/memes/docker-was-born.jpeg";
...
<Image
  src={dockerWasBorn}
  alt="And that is how Docker was born meme"
  className="mx-auto"
/>
...
<Image src={docker} alt="Docker Inc. logo" />
