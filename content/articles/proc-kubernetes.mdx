export const meta = {
  ...
  description:
    "V tomhle článku píšu o tom, proč je Kubernetes tak rozšířené, a proč tu s námi bude ještě dlouho.",
...
Pokud Vás Kubernetes zajímá a chcete se dozvedět více, nebo jste CTO a chcete aby Váš tým více rozumněl Kubernetes? Budu rád když přijdete na mé [školení Kubernetes](/skoleni/kubernetes).
Nebo se domluvíme na firemním školení přímo pro Váš tým u Vás ve firmě, napište mi na vojtech@mares.cz.
