...
import argo from "@/images/logos/argo.png";
import kargoGuestbookScreenshot from "@/images/screenshots/kargo-guestbook-screenshot.png";
...
<Image src={argo} alt="Argo logo" width={200} className="mx-auto" />
...
<Image
  src={kargoGuestbookScreenshot}
  alt="Kargo Guestbook demo screenshot"
  className="mx-auto"
/>
