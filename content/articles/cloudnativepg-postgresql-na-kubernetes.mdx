...
import cnpgReplicaCluster from "@/images/blog/cnpg-replica-cluster.png";
...
export const meta = {
  ...
  keywords:
    "kubernetes, postgres, cloudnative, cnpg, cloudnativepg, postgresql",
  lang: "cs",
  publishDate: "2024-10-17",
  trainingAd: "postgres-on-k8s",
};

# CloudNativePG: PostgreSQL na Kubernetes
...
<Image
  src={cnpgReplicaCluster}
  alt="Diagram CNPG a replika clusteru"
  classNames="mx-auto"
/>
