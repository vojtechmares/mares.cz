...
describe("SessionsHero", () => {
  it("renders empty state when sessionCount is 0", () => {
    render(<SessionsHero sessionCount={0} topicCount={0} nextSessionDate={null} />);
  ...
  it("renders stats when sessionCount > 0", () => {
    render(<SessionsHero sessionCount={5} topicCount={3} nextSessionDate="2025-04-15" />);
  ...
  it("omits date box when nextSessionDate is null", () => {
    render(<SessionsHero sessionCount={5} topicCount={3} nextSessionDate={null} />);
